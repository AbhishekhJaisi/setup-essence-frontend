    ...
    <div className="min-h-screen bg-[linear-gradient(135deg,#f7fbff_0%,#f7f3ff_48%,#fff8f0_100%)] text-[#1d1d1f] flex flex-col">
      <header className="px-6 py-5">
        <div className="inline-flex items-center gap-2.5">
          <img
            src={eventosMark}
            alt="Eventos"
            className="h-9 w-9 rounded-xl shadow-[0_8px_18px_rgba(37,99,235,0.24)]"
          />
          <div className="leading-tight">
            <p className="text-[18px] font-semibold text-[#1d1d1f]">Eventos</p>
            <p className="text-[10px] tracking-[0.1em] uppercase text-[#6e6e73]">
              Event Management
            </p>
          </div>
        </div>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-10 items-center">
          <section>
            <p className="text-xs tracking-[0.14em] uppercase text-[#0071e3] font-semibold mb-3">
              Welcome back
            </p>
            ...
            <p className="mt-6 text-lg text-[#424245] max-w-xl">
              Manage events, registrations, and updates from one calm, focused
              dashboard.
            </p>
          </section>
          ...
          <section className="rounded-2xl border border-black/5 bg-white/90 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] p-6 sm:p-8">
            <form onSubmit={HandleSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <label htmlFor="rememberMe" className="text-xs text-[#424245]">
                  Remember me
                </label>
                <button
                  type="button"
              ...
              <p className="text-sm text-[#d70015] min-h-[20px]">
                {errorlogin}
              </p>
